...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabraEspaciada = palabras.join(' '); // Aquí concatenamos las palabras con un espacio.
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   let promedio = 0;
   resultadosTest.forEach((nota) => promedio += nota);
...
function mesesDelAño(array) {
   ...
   var comp1 = nuevoArreglo.includes("Enero");
   var comp2 = nuevoArreglo.includes("Marzo");
   var comp3 = nuevoArreglo.includes("Noviembre");
